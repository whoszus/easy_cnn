...
def main():
    ...
    parser.add_argument('-train_src', default='data/multi30k/train.en.atok')
    parser.add_argument('-train_tgt', default='data/multi30k/train.de.atok')
    parser.add_argument('-valid_src', default='data/multi30k/val.en.atok')
    parser.add_argument('-valid_tgt', default='data/multi30k/val.de.atok')
    parser.add_argument('-save_data', default='data/multi30k.atok.low.pt')
