...
def main():
    ...
    parser.add_argument('-data_all', default='data/data-m6-500w-uc.pt')
    parser.add_argument('-data_set', default='data/data-set-m6-500w-uc.pt')
    parser.add_argument('-save_model', default='data-set-m6-500w-uc')
