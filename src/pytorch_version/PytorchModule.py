...
data = load_data1()
new_data_x =convert2onehot1(data)


# prepare training data
new_data_x = new_data_x.values.astype(np.float32)# change to numpy array and float32
...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.out = nn.Linear(32 * 8 * 8, 16*2)   # fully connected layer, output 10 classes
